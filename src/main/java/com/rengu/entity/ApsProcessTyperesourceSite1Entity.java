 ...
 */
@Entity
@Table(name = "aps_process_typeresource_site1", schema = "testdatabase", catalog = "")
public class ApsProcessTyperesourceSite1Entity {
    private String idProcess;
    private String idTypeResource;
    private String primaryForTime;
    private String primaryForNext;
    ...
    @Basic
    @Column(name = "primaryForNext")
    public String getPrimaryForNext() {
        return primaryForNext;
    }

    public void setPrimaryForNext(String primaryForNext) {
        this.primaryForNext = primaryForNext;
    }
    ...
    public boolean equals(Object o) {
        ...
        ApsProcessTyperesourceSite1Entity that = (ApsProcessTyperesourceSite1Entity) o;
        ...
        if (primaryForTime != null ? !primaryForTime.equals(that.primaryForTime) : that.primaryForTime != null)
            return false;
        if (primaryForNext != null ? !primaryForNext.equals(that.primaryForNext) : that.primaryForNext != null)
            return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (primaryForNext != null ? primaryForNext.hashCode() : 0);
