 ...
 */
@Entity
@Table(name = "aps_resource_typeresource2", schema = "testdatabase", catalog = "")
public class ApsResourceTyperesource2Entity {
    ...
    public boolean equals(Object o) {
        ...
        ApsResourceTyperesource2Entity that = (ApsResourceTyperesource2Entity) o;
