...
<div class="<%--uk-grid--%>"
    ...
    <div class="data-uk-button-radio btngroup" style="/*margin-top: 5px;float: right;margin-right: 1%;*/">
        <button class="uk-button uk-icon-plus uk-button-primary" ng-click="reset()" data-uk-modal="{target:'#add'}">新增
        </button>
        <button class="uk-button uk-icon-edit uk-button-primary" ng-click="edit()" data-uk-modal="{target:'#edit'}">修改
        </button>
        ...
        <div id="dialog-form" title="订单信息">
            <form class="uk-form uk-form-horizontal">
                <fieldset>
                    ...
                    <input type="text" name="add-origin" id="add-origin" title="请输入a-z/A-Z之间字母组成的字符串！"
                           class="ui-widget-content ui-corner-all"><br/>
                    <label for="add-quantity">数量</label><br/>
                    <input type="text" name="add-quantity" id="add-quantity" title="请输入正确的数字！"
                           class=" ui-widget-content ui-corner-all"><br/>
                    <label for="add-priority">优先级</label><br/>
                    <input type="text" name="add-priority" id="add-priority" title="请输入0-9之间的数字！"
                           class=" ui-widget-content ui-corner-all"><br/>
