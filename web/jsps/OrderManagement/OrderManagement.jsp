...
<span style="font-size: 18px;font-weight: 700;margin-top: 10px;/*margin-left: -24px;*/font-family: 微软雅黑">制造BOM管理</span>--%>
    ...
    <div class="data-uk-button-radio" style="margin-top: 5px;float: right;margin-right: 1%;">
        ...
        <button class="uk-button uk-icon-edit uk-button-primary" ng-click="editOrder()"
        ...
        <div id="dialog-form" title="订单信息">
            <form class="uk-form uk-form-horizontal">
                <fieldset>
                    ...
                    <input type="text" name="add-origin" id="add-origin"
                    ...
                    <input type="text" name="add-priority" id="add-priority"
                           class="text ui-widget-content ui-corner-all"><br/>
        ...
        <div id="dialog-form" title="订单信息">
            <form>
                <fieldset ng-repeat="x in form track by $index">
                    ...
                    <input type="text" name="edit-origin" id="edit-origin" class="text ui-widget-content ui-corner-all"
                           value="{{x.origin}}"><br/>
                    ...
                    <input type="text" name="edit-priority" id="edit-priority"
                           class="text ui-widget-content ui-corner-all" value="{{x.priority}}"><br/>
                    <label for="edit-t0">下单时间</label><br/>
                    <input type="text" name="edit-t0" id="edit-t0" class="text ui-widget-content ui-corner-all"
                           value="{{x.t0}}"><br/>
                    <label for="edit-t1">最早开工</label><br/>
                    <input type="text" name="edit-t1" id="edit-t1" class="text ui-widget-content ui-corner-all"
                           value="{{x.t1}}"><br/>
                    <label for="edit-t2">最晚开工</label><br/>
                    <input type="text" name="edit-t2" id="edit-t2" class="text ui-widget-content ui-corner-all"
                           value="{{x.t2}}"><br/>
                </fieldset>
            </form>
        </div>
